...
export const subjectTypeSchema = z.enum(['CLOSE_ASSOCIATE', 'PERSON_OF_INTEREST'])
...
export const subjectCreateSchema = z.object({
  ...
  birthDate: z.string().min(1, i18n.t('subject.validation.birthDateRequired')),
  birthPlace: z.string().trim().min(1, i18n.t('subject.validation.birthPlaceRequired')),
